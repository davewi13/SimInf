    ...
    double t)
{
    ...
    /* Have changed the above so that it includes infecteds only going to the susceptible - some need to become carriers */
}
...
double SISe_sp_I_to_C(
    ...
    double t)
{
  return gdata[GAMMA] * gdata[QPROP] * u[I];
